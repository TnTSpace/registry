...
<div
	class={cn(
		'border-input bg-background flex min-h-[50px] w-full flex-wrap place-items-center gap-2 rounded-md border px-2 py-2 disabled:opacity-50 aria-disabled:cursor-not-allowed',
		className
	)}
...
>
	...
	<input
		...
		onkeydown={keydown}
		class="placeholder:text-muted-foreground min-w-16 shrink grow basis-0 border-none bg-transparent px-2 outline-none focus:outline-none disabled:cursor-not-allowed data-[invalid=true]:text-red-500 md:text-sm"
	/>
</div>
