	...
	<div class="container py-24 lg:py-32">
		...
		<div class="flex justify-center">
			...
			>
				...
				<span
					class="inline-flex items-center justify-center gap-x-2 rounded-full bg-muted-foreground/15 px-2.5 py-1.5 text-sm font-semibold"
				>
					<svg
		...
		<div class="mx-auto mt-5 max-w-3xl text-center">
			<p class="text-xl text-muted-foreground">
				Over 10+ fully responsive, UI blocks you can drop into your Shadcn UI projects and customize
